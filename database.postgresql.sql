...
DROP TABLE IF EXISTS field_services CASCADE;
...
-- Field Services Table - for managing accompanying services at each field
...
CREATE INDEX idx_field_services_field_id ON field_services(field_id);
...
-- =====================================================================
-- 
-- Football Booking System - Complete PostgreSQL Database Schema
-- Version: 2.0 (2026-06-17)
-- Last Updated: Added field_services table for companion services management
--
-- TABLES:
-- 1. users - User accounts (customers, owners, admins)
-- 2. owners - Owner profile linked to users
-- 3. fields - Football fields managed by owners
-- 4. field_images - Images for fields
-- 5. field_services - Companion services offered at fields (NEW)
-- 6. reviews - Customer reviews for fields
-- 7. review_replies - Owner replies to reviews
-- 8. bookings - Booking records
-- 9. booking_services - Services associated with each booking
-- 10. conversations - Chat conversations between customers and owners
-- 11. messages - Messages within conversations
--
-- KEY FEATURES:
-- • Full-text search support with accent-insensitive matching
-- • Field services management for owners
...
-- • Messaging system between customers and owners
-- • Cascade deletion for data integrity
--
-- EXTENSIONS REQUIRED:
-- • unaccent - For Vietnamese text search
-- • pg_trgm - For trigram search optimization
--
